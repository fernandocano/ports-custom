...
pkg_setup() {
	...
	# Make sure that build cflags are set
	export CFLAGS_FOR_BUILD="-frecord-gcc-switches"
	export CXXFLAGS_FOR_BUILD="-frecord-gcc-switches"
}
...
src_prepare() {
	...
	if ! use vanilla; then
		...
		epatch "${FILESDIR}/gcc-5.3.0-ckswitches.patch"
