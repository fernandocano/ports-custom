...
src_unpack() {
	...
	epatch "${FILESDIR}"/10-clean-libubacktrace.patch
	...
	for def in ${moredefs} MALLOC_GLIBC_COMPAT DO_C99_MATH UCLIBC_HAS_{RPC,FULL_RPC,CTYPE_CHECKED,WCHAR,HEXADECIMAL_FLOATS,GLIBC_CUSTOM_PRINTF,FOPEN_EXCLUSIVE_MODE,GLIBC_CUSTOM_STREAMS,PRINTF_M_SPEC,FTW,THREADS_NATIVE,TLS,STDIO_FUTEXES,LIBUTIL,LIBRESOLV_STUB,LIBNSL_STUB} UCLIBC_HAS_REENTRANT_RPC  UCLIBC_HAS_GNU_GLOB PTHREADS_DEBUG_SUPPORT UCLIBC_HAS_TZ_FILE_READ_MANY UCLIBC_HAS_FENV UCLIBC_SUSV3_LEGACY UCLIBC_SUSV3_LEGACY_MACROS UCLIBC_HAS_PROGRAM_INVOCATION_NAME EXTRA_WARNINGS; do
		set_opt "${def}" y
	done
	set_opt UCLIBC_HAS_CTYPE_UNSAFE n
	set_opt UCLIBC_HAS_LOCALE y
	set_opt UCLIBC_BUILD_MINIMAL_LOCALE y
	set_opt UCLIBC_BUILD_MINIMAL_LOCALES "\"en_US\""
